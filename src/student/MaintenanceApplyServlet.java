...
public class MaintenanceApplyServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		try (PrintWriter out = response.getWriter()) {
			...
			//http://localhost:8080/Dormitory/servlet/MaintenanceApplyServlet?s_id=201830660178&building=C10&room_num=101&maintenance=E&contact=1000
			...
			String time = "2018"; 	//request.getParameter("time").trim();
