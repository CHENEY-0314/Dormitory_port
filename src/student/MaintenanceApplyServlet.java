...
public class MaintenanceApplyServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		try (PrintWriter out = response.getWriter()) {
			...
			//http://localhost:8080/Dormitory/servlet/MaintenanceServlet?
			// s_id=201801010101&building=C10&room_num=101&maintenance=Electrical appliances&contact=10000000000
...
//			String time = request.getParameter("time").trim();
			...
			if (MainAppDAO.insertApp(ID, building, room_num, maintenance, contact)) {
